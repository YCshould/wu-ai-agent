...
//                .advisors(LoveAppRagCustomAdvisorFactory.createLoveAppRagCustomAdvisorFactory(loveAppVectorStore,"单身"))
    ...
    @Resource
    private ToolCallback[] allTools;  //直接注入所有注册的工具对象
    ...
    @Resource
    private ToolCallbackProvider toolCallbackProvider;  //这个可以拿取到注册的mcp的工具对象，一般情况还是用allTools更安全
    /**
     * mcp对话，调用外部工具
     * @param message
     * @param chatId
